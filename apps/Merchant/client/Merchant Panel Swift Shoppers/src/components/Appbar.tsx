        ...
        <nav className="w-full shadow py-1">
            <div className="flex flex-row align-middle w-full h-auto">
                ...
                <div className="p-3 flex pl-20 pr-0">
                    <Link to="/Signin" className="px-6 py-4 hover:bg-slate-100 cursor-pointer flex justify-between">
                    ...
                    <Link className="px-6 py-4 hover:bg-slate-100 cursor-pointer mr-3" to="/sell/dashboard">
                        <span>
                            Sell
                        </span>
                    </Link>
