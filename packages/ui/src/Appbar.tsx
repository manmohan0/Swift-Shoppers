export const Appbar = () => {
    ...
    <nav className="w-full shadow">
        <div className="flex flex-row align-middle w-full h-auto">
            ...
            <input className="p-0 px-3 m-2 ml-20 bg-slate-100 rounded-md border-gray-300 flex-auto" placeholder="Search for Products, Brands and More" type="text" name="search" id="search" />
